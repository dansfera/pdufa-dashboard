...
const CATALYST_DATA = [
  ...
  // ── AUDIT ADDITIONS (2026-07-08): CORT + missing mid-cap PDUFAs, primary-source verified ──
  {
    catalyst_type: 'pdufa',
    drug_name: 'relacorilant + nab-paclitaxel',
    brand_name: 'Lifyorli',
    company: 'Corcept Therapeutics',
    ticker: 'CORT',
    cashtag: '$CORT',
    pdufa_date: '2026-03-25',
    indication: 'Platinum-resistant epithelial ovarian, fallopian tube, or primary peritoneal cancer',
    review_type: 'standard',
    designation: ['Orphan Drug', 'Fast Track'],
    phase: 'NDA',
    nda_bla_type: 'NDA',
    status: 'approved',
    notes: 'FDA approved Lifyorli (relacorilant) plus nab-paclitaxel on March 25, 2026, ahead of the original PDUFA target of July 11, 2026. First approval for Corcept lead compound. Based on the Phase 3 ROSELLA trial (n=381), which met overall survival and PFS endpoints in platinum-resistant ovarian cancer after 1 to 3 prior lines including bevacizumab. Selective glucocorticoid receptor antagonist. Source: FDA and Corcept press release (March 25, 2026).',
    slug: 'relacorilant-cort-ovarian-cancer'
  },
  {
    catalyst_type: 'pdufa',
    drug_name: 'relacorilant',
    brand_name: null,
    company: 'Corcept Therapeutics',
    ticker: 'CORT',
    cashtag: '$CORT',
    pdufa_date: '2025-12-30',
    indication: 'Hypertension secondary to endogenous hypercortisolism (Cushing syndrome)',
    review_type: 'standard',
    designation: ['Orphan Drug'],
    phase: 'NDA',
    nda_bla_type: 'NDA',
    status: 'CRL',
    notes: 'FDA issued a Complete Response Letter for relacorilant in hypercortisolism in late December 2025. The agency acknowledged the pivotal GRACE trial met its primary endpoint and that GRADIENT provided confirmatory evidence, but concluded it could not reach a favorable benefit-risk assessment without additional evidence of effectiveness. Corcept lead compound, separately approved as Lifyorli in ovarian cancer in March 2026. Source: Corcept press release (CRL, December 2025).',
    slug: 'relacorilant-cort-hypercortisolism-crl'
  },
  {
    catalyst_type: 'pdufa',
    drug_name: 'DTX401 (pariglasgene brecaparvovec)',
    brand_name: null,
    company: 'Ultragenyx Pharmaceutical',
    ticker: 'RARE',
    cashtag: '$RARE',
    pdufa_date: '2026-08-23',
    indication: 'Glycogen Storage Disease Type Ia (GSDIa), AAV8 gene therapy',
    review_type: 'priority',
    designation: ['Priority Review', 'Orphan Drug'],
    phase: 'BLA',
    nda_bla_type: 'BLA',
    status: 'upcoming',
    notes: 'FDA accepted the BLA and granted Priority Review with a PDUFA target action date of August 23, 2026. Supported by the randomized, double-blind, placebo-controlled Phase 3 GlucoGene study plus data from 52 treated patients with up to six years of follow-up. One-time AAV8 gene therapy aiming to reduce reliance on cornstarch dosing in GSDIa. Source: Ultragenyx press release (BLA acceptance, February 2026).',
    slug: 'dtx401-rare-gsd1a-gene-therapy'
  },
  {
    catalyst_type: 'pdufa',
    drug_name: 'zidesamtinib (NVL-520)',
    brand_name: null,
    company: 'Nuvalent',
    ticker: 'NUVL',
    cashtag: '$NUVL',
    ...
    nda_bla_type: 'NDA',
    status: 'upcoming',
    notes: 'FDA accepted the NDA with Priority Review and a PDUFA target action date of September 18, 2026. Brain-penetrant, ROS1-selective inhibitor designed to spare TRK and reduce related toxicity, supported by the ARROS-1 pivotal trial. Nuvalent lead program alongside neladalkib (ALK, PDUFA November 27, 2026). Source: Nuvalent 8-K and IR (NDA acceptance 2026).',
    slug: 'zidesamtinib-nuvl-ros1-nsclc'
  },
  {
    catalyst_type: 'pdufa',
    drug_name: 'apitegromab',
    brand_name: null,
    company: 'Scholar Rock',
    ticker: 'SRRK',
    cashtag: '$SRRK',
    pdufa_date: '2026-09-30',
    indication: 'Spinal muscular atrophy (SMA), add-on to SMN-targeted therapy',
    review_type: 'standard',
    designation: ['Breakthrough Therapy', 'Orphan Drug'],
    phase: 'BLA',
    nda_bla_type: 'BLA',
    status: 'upcoming',
    notes: 'BLA resubmitted in 2026 with FDA action expected in late September 2026 (PDUFA target near September 30, 2026). Selective myostatin inhibitor intended to improve motor function on top of nusinersen or risdiplam, based on the Phase 3 SAPPHIRE trial. First potential muscle-directed therapy in SMA. Source: Scholar Rock IR (BLA resubmission, 2026).',
    slug: 'apitegromab-srrk-sma'
  },
  {
    catalyst_type: 'pdufa',
    ...
    indication: 'EGFR-mutated advanced non-squamous NSCLC after progression on a 3rd-gen EGFR TKI (with chemotherapy)',
    review_type: 'standard',
    designation: ['Fast Track'],
    phase: 'BLA',
    nda_bla_type: 'BLA',
    status: 'upcoming',
    notes: 'FDA accepted the BLA for ivonescimab plus platinum-doublet chemotherapy with a PDUFA goal date of November 14, 2026. First-in-class PD-1 by VEGF bispecific antibody. BLA based on the Phase 3 HARMONi trial (ivonescimab plus chemo vs placebo plus chemo in EGFRm NSCLC post-TKI). Partnered with Akeso. Source: Summit 8-K and press release (BLA acceptance, January 2026).',
    slug: 'ivonescimab-smmt-egfr-nsclc'
  },
  {
    catalyst_type: 'pdufa',
    drug_name: 'neladalkib (NVL-655)',
    brand_name: null,
    company: 'Nuvalent',
    ticker: 'NUVL',
    cashtag: '$NUVL',
    pdufa_date: '2026-11-27',
    indication: 'TKI-pretreated advanced ALK-positive non-small cell lung cancer (NSCLC)',
    review_type: 'standard',
    designation: ['Breakthrough Therapy'],
    phase: 'NDA',
    nda_bla_type: 'NDA',
    status: 'upcoming',
    notes: 'FDA accepted the NDA with a PDUFA target action date of November 27, 2026. Brain-penetrant, ALK-selective inhibitor designed to overcome resistance mutations (including G1202R compound mutations) while sparing TRK, supported by the ALKOVE-1 pivotal trial. Companion to zidesamtinib (ROS1, PDUFA September 18, 2026). Source: Nuvalent IR (NDA acceptance 2026).',
    slug: 'neladalkib-nuvl-alk-nsclc'
  },
  {
    catalyst_type: 'pdufa',
    ...
    indication: 'Uncontrolled or resistant hypertension (add-on to other antihypertensives)',
    review_type: 'standard',
    designation: ['Fast Track'],
    phase: 'NDA',
    nda_bla_type: 'NDA',
    status: 'upcoming',
    notes: 'FDA accepted the NDA with a PDUFA target action date of December 22, 2026. Aldosterone synthase inhibitor for uncontrolled and resistant hypertension, supported by the Phase 3 Launch-HTN and Advance-HTN trials plus the Transform-HTN open-label extension. Source: Mineralys 8-K and IR (NDA acceptance, Q1 2026).',
    slug: 'lorundrostat-mlys-hypertension'
  },
  {
    catalyst_type: 'pdufa',
    drug_name: 'lecanemab',
